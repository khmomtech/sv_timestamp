...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Future<void> _pickCustomLogo() async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('${AppLocalizations.of(context)!.logoUpdateError}: $e'),
  ...
  void _removeCustomLogo() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: Text(AppLocalizations.of(context)!.removeLogoTitle),
        content: Text(AppLocalizations.of(context)!.removeLogoContent),
        actions: [
          TextButton(
          ...
          TextButton(
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(
                  content: Text(AppLocalizations.of(context)!.logoRemoved),
                  backgroundColor: Colors.green,
                ),
              );
            },
